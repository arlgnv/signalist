export const GENERATE_INTRO_FOR_WELCOME_EMAIL = `Generate highly personalized HTML content that will be inserted into an email template at the {{intro}} placeholder.
